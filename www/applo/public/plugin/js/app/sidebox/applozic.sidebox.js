     ...
     _this.deleteFriendContactList = function(param) {
        ...
        function MckInit() {
            ...
            _this.getLauncherHtml = function() {
                //return '<div id="mck-sidebox-launcher" class="mck-sidebox-launcher">' + '<div class="applozic-launcher mck-button-launcher"></div></div>';
            };
        ...
        function MckMessageLayout() {
            ...
            var markup = '<div name="message" data-msgdelivered="${msgDeliveredExpr}" data-msgsent="${msgSentExpr}" data-msgtype="${msgTypeExpr}" data-msgtime="${msgCreatedAtTime}" data-msgcontent="${replyIdExpr}" data-msgkey="${msgKeyExpr}" data-contact="${toExpr}" id="${msgKeyExpr}" class="mck-m-b ${msgKeyExpr} ${msgFloatExpr} ${msgAvatorClassExpr}">' +
                ...
                '<div class="mck-file-text notranslate mck-attachment downloadimage ${downloadIconVisibleExpr}" data-filemetakey="${fileMetaKeyExpr}" data-filename="${fileNameExpr}" data-fileurl= "${fileUrlExpr}" data-filesize="${fileSizeExpr}"><div>{{html fileExpr}}</div></div>' +
            ...
            _this.getFilePath = function(msg) {
                ...
                if (typeof msg.fileMeta === "object") {
                    if (msg.fileMeta.contentType.indexOf("image") !== -1) {
                        ...
                        return '<a href="#" role="link" class="file-preview-link" target="_blank" style="color:#fff"></a>';
                    }
                }
                return '';
            };
